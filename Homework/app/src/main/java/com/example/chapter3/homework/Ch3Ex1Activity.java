...
public class Ch3Ex1Activity extends AppCompatActivity {
    ...
    private static int MAX_PROGRESS_BAR = 100;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                float animationProgress = (float)progress/MAX_PROGRESS_BAR;
                ...
                Log.d(TAG,"seekBarChanged,progress is "+animationProgress);
                animationView.setProgress(animationProgress);
                Log.d(TAG,"progress:"+animationView.getProgress());
